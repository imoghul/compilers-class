...
| ID NUMBER ASSIGN ensemble ENDLINE{
  arguments[$1] = Builder.CreateOr(Builder.CreateAnd(arguments[$1],Builder.CreateNot(Builder.CreateShl(Builder.CreateAnd($4,Builder.getInt32(1)),$2))),Builder.CreateShl(Builder.CreateAnd($4,Builder.getInt32(1)),$2));
}
| ID LBRACKET ensemble RBRACKET ASSIGN ensemble ENDLINE{
  arguments[$1] = Builder.CreateOr(Builder.CreateAnd(arguments[$1],Builder.CreateNot(Builder.CreateShl(Builder.CreateAnd($6,Builder.getInt32(1)),$3))) , Builder.CreateShl(Builder.CreateAnd($6,Builder.getInt32(1)),$3));
}
;
...
| ensemble COMMA expr{
  $$ = Builder.CreateOr($3, Builder.CreateShl($1,Builder.getInt32(1)));
}
...
| ID LBRACKET ensemble RBRACKET{
  $$ = Builder.CreateAnd(Builder.CreateLShr(arguments[$1],$3),Builder.getInt32(1));
}
